...
namespace RouteViewer
{
    internal class RouteViewer : GameWindow
    {
        ...
        public RouteViewer(int width, int height, GraphicsMode currentGraphicsMode, string windowTitle, GameWindowFlags @default, GraphicsContextFlags flags): base (width, height, currentGraphicsMode, windowTitle, @default, DisplayDevice.Default, 4, Program.CurrentHost.Platform == HostPlatform.AppleOSX ? 1 : 3, flags)
        {
            try
            {
