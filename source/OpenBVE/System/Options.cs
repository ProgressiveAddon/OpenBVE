	...
	internal partial class Interface
	{
		internal class Options : BaseOptions
		{
			...
			public override void Save(string fileName)
			{
				...
				Builder.AppendLine("useEmissiveLighting = " + (UseEmissiveLighting ? "true" : "false"));
				...
				while (cfg.RemainingSubBlocks > 0)
				{
					...
					switch (block.Key)
					{
						...
						case OptionsSection.Quality:
						{
							...
							block.GetValue(OptionsKey.UseEmissiveLighting, out Interface.CurrentOptions.UseEmissiveLighting);
